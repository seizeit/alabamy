...
- [ ] **1.01** Scaffold Next.js project with `npx create-next-app@latest . --typescript --tailwind --eslint --app --src-dir --import-alias "@/*"` — answer prompts non-interactively, preserve existing files (CLAUDE.md, PROJECT_PLAN.md, TODO.md, COMPLETED.md, build_loop.sh, public/ assets)
- [ ] **1.02** Install dependencies: `npm install drizzle-orm @libsql/client rss-parser @mendable/firecrawl-js` and `npm install -D drizzle-kit tsx`
